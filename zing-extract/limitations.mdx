...
- **File Format** - The extractor can only process pdf files, ensure that you verify the file format before running requests on the API
- **Accuracy** - Data extracted from documents are accurate but we’re still working on being 100% perfect so you may get some unsure values on very rare occasions. If you do, please don’t hesitate to reach out or help us improve by rating the accuracy of your results.
