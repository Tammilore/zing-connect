...
### Sandbox Credentials
To test in the sandbox environment, you'll need credentials to sign in to the payroll accounts on the widget before calling the API to fetch data. Use the credentials below to test all providers.

``` 
Username/Email/Phone: test_user
